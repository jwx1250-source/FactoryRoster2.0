...
export const metadata: Metadata = { title: "China Supplier Sourcing Guides", description: "Practical supplier sourcing and verification guidance for global buyers.", alternates: { canonical: `${siteUrl}/guides` } };
