...
function Nav({ onHome, page, onNav }: { onHome: () => void; page: Page; onNav: (k: string) => void }) {
  ...
  return (
    <header style={{ position: "sticky", top: 0, zIndex: 50, background: "rgba(255,255,255,0.95)", backdropFilter: "blur(8px)", borderBottom: "1px solid #E9ECF1" }}>
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 36px", height: 64, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <a href="#" onClick={(e) => { e.preventDefault(); onHome(); }} style={{ textDecoration: "none" }}>
  ...
  return (
    <section style={{ background: "#fff", borderTop: "1px solid #E9ECF1", borderBottom: "1px solid #E9ECF1" }}>
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "64px 32px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 1, background: "#E9ECF1" }}>
  ...
  return (
    <section style={{ maxWidth: 1280, margin: "0 auto", padding: "64px 32px" }}>
      ...
      <div style={{ background: "#fff", border: "1px solid #E9ECF1", borderRadius: 10, overflow: "hidden" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 140px 140px 130px 110px", padding: "10px 20px", background: "#F7F8FA", borderBottom: "1px solid #E9ECF1" }}>
        ...
        {RECENT_FACTORIES.map((f, i) => (
          <a key={f.id} href="#" onClick={(e) => { e.preventDefault(); onDetail(f); }}
            style={{ display: "grid", gridTemplateColumns: "1fr 140px 140px 130px 110px", padding: "14px 20px", borderBottom: i < RECENT_FACTORIES.length - 1 ? "1px solid #F0F1F3" : undefined, textDecoration: "none", background: "#fff", alignItems: "center", transition: "background 0.1s" }}
  ...
  return (
    <section style={{ background: "#fff", borderTop: "1px solid #E9ECF1", borderBottom: "1px solid #E9ECF1" }}>
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "64px 32px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 1, background: "#E9ECF1" }}>
...
function SearchResultsPage({ query, onDetail, onSearch }: { query: string; onDetail: (f: SearchResult) => void; onSearch: (q: string) => void }) {
  ...
  const filtered = activeProvince ? SEARCH_RESULTS.filter((r) => r.province === activeProvince) : SEARCH_RESULTS;
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#F7F8FA" }}>
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "24px 32px", display: "grid", gridTemplateColumns: "220px 1fr", gap: 28 }}>
        ...
        <aside>
          ...
          <FilterSection title="Province">
            <FilterOption label="All provinces" count={847} active={activeProvince === null} onClick={() => setActiveProvince(null)} />
            {FILTER_PROVINCES.map((p) => (
              <FilterOption key={p.name} label={p.name} count={p.count} active={activeProvince === p.name} onClick={() => setActiveProvince(p.name === activeProvince ? null : p.name)} />
            ))}
          </FilterSection>
        ...
        <main>
          ...
          <div style={{ marginBottom: 16 }}>
            <h1 style={{ fontSize: 19, fontWeight: 700, letterSpacing: "-0.4px", color: "#0D1117", marginBottom: 4 }}>
              {filtered.length} Verified LED Lighting Manufacturers
            </h1>
...
function FactoryDetailPage({ factory, fromQuery, onBack }: { factory: SearchResult; fromQuery: string; onBack: () => void }) {
  ...
  const overviewStats = [
    { label: "Established", value: d.established.toString(), verified: true },
    { label: "Employees", value: d.employees, verified: true },
    { label: "Factory Size", value: d.factorySize, verified: false },
    { label: "Production Lines", value: d.productionLines.toString(), verified: false },
    { label: "Annual Revenue", value: d.annualRevenue, verified: false },
    { label: "OEM / ODM", value: d.oemOdm, verified: true },
  ];
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#F7F8FA" }}>
          ...
          <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 24 }}>
            <div>
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
                ...
                <div>
                  <h1 style={{ fontSize: 22, fontWeight: 800, letterSpacing: "-0.5px", color: "#0D1117", lineHeight: 1.2 }}>{factory.name}</h1>
                  <p style={{ fontSize: 12, color: "#9CA3AF", marginTop: 2 }}>{d.nameZh}</p>
                </div>
              </div>
              <div style={{ display: "flex", alignItems: "center", gap: 14, flexWrap: "wrap" as const, marginBottom: 10 }}>
                <Mono color="#6B7280">{d.subIndustry}</Mono>
                <span style={{ width: 1, height: 12, background: "#E5E7EB" }} />
                <Mono color="#6B7280">{d.district}, {factory.city}, {factory.province}, China</Mono>
                <span style={{ width: 1, height: 12, background: "#E5E7EB" }} />
                <Mono color="#9CA3AF">Est. {d.established}</Mono>
                <span style={{ width: 1, height: 12, background: "#E5E7EB" }} />
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 8, flexShrink: 0 }}>
              <button style={{ padding: "9px 20px", borderRadius: 8, background: "#1E40AF", color: "#fff", fontSize: 13.5, fontWeight: 600, border: "none", cursor: "pointer", letterSpacing: "-0.1px" }}>
                Unlock Contact
              </button>
      ...
      {/* Main content */}
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "28px 32px", display: "grid", gridTemplateColumns: "1fr 320px", gap: 24, alignItems: "flex-start" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <div style={{ background: "#fff", border: "1px solid #E9ECF1", borderRadius: 10, overflow: "hidden" }}>
            ...
            <div style={{ padding: "16px 22px" }}>
              <p style={{ fontSize: 13.5, color: "#6B7280", lineHeight: 1.7, marginBottom: 20 }}>{d.overview}</p>
              <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 0, border: "1px solid #E9ECF1", borderRadius: 8, overflow: "hidden" }}>
            ...
            <div style={{ background: "#fff", border: "1px solid #E9ECF1", borderRadius: 10, overflow: "hidden" }}>
              ...
              <div style={{ padding: "16px 22px" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                  {[["Trade Terms", d.tradeTerms], ["Min. Order", d.minOrder]].map(([k, v]) => (
        ...
        <aside style={{ position: "sticky", top: 66 }}>
          ...
          <div style={{ background: "#fff", border: "1px solid #E9ECF1", borderRadius: 10, overflow: "hidden", marginBottom: 12 }}>
            ...
            <div style={{ padding: "14px 20px 16px", borderTop: "1px solid #E9ECF1" }}>
              <button style={{ width: "100%", padding: "11px 0", borderRadius: 8, background: "#1E40AF", color: "#fff", fontSize: 14, fontWeight: 600, border: "none", cursor: "pointer", letterSpacing: "-0.1px", marginBottom: 8 }}>
                Unlock Contact
              </button>
          ...
          <div style={{ background: "#fff", border: "1px solid #E9ECF1", borderRadius: 10, padding: "16px 20px", marginBottom: 12 }}>
            ...
            <button style={{ width: "100%", padding: "8px 0", borderRadius: 7, background: "transparent", border: "1px solid #D1D5DB", fontSize: 13, fontWeight: 600, color: "#374151", cursor: "pointer" }}>
...
function IndustriesPage({ onSearch, onNav }: { onSearch: (q: string) => void; onNav?: (k: string) => void }) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#F7F8FA" }}>
      ...
      {/* Compact page header */}
      <section style={{ background: "#fff", borderBottom: "1px solid #E9ECF1" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "40px 32px 36px" }}>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 32px 20px", display: "flex", alignItems: "center", gap: 10 }}>
          {/* Search input */}
      ...
      <section style={{ maxWidth: 1280, margin: "0 auto", padding: "44px 32px 40px" }}>
        <div style={{ display: "flex", alignItems: "baseline", justifyContent: "space-between", marginBottom: 24 }}>
          <div>
...
function VerificationPage({ onSearch, onIndustries, onPricing, onNav }: { onSearch: (q: string) => void; onIndustries: () => void; onPricing: () => void; onNav?: (k: string) => void }) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#F7F8FA" }}>
      ...
      {/* Three checks */}
      <section style={{ maxWidth: 1280, margin: "0 auto", padding: "56px 32px 48px" }}>
      ...
      <section style={{ background: "#fff", borderTop: "1px solid #E9ECF1", borderBottom: "1px solid #E9ECF1" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "52px 32px" }}>
          ...
          <div style={{ border: "1px solid #E9ECF1", borderRadius: 10, overflow: "hidden" }}>
            <div style={{ display: "grid", gridTemplateColumns: "1.1fr 1.4fr 1.5fr 1.4fr", background: "#F7F8FA", borderBottom: "1px solid #E9ECF1", padding: "10px 20px", gap: 16 }}>
            ...
            {[
              ...
              <div key={row.area} style={{ display: "grid", gridTemplateColumns: "1.1fr 1.4fr 1.5fr 1.4fr", padding: "15px 20px", borderBottom: i < 2 ? "1px solid #F0F1F3" : undefined, gap: 16, alignItems: "flex-start" }}>
      ...
      <section style={{ maxWidth: 1280, margin: "0 auto", padding: "52px 32px" }}>
            ...
            <div>
              ...
              <div style={{ background: "#fff", border: "1px solid #E9ECF1", borderRadius: 10, overflow: "hidden" }}>
                ...
                <div style={{ padding: "12px 20px 16px", borderTop: "1px solid #E9ECF1" }}>
                  <button style={{ width: "100%", padding: "9px 0", borderRadius: 7, background: "#1E40AF", color: "#fff", fontSize: 13.5, fontWeight: 600, border: "none", cursor: "pointer" }}>Unlock Contact</button>
                </div>
              </div>
            </div>
          </div>
      ...
      <section style={{ maxWidth: 1280, margin: "0 auto", padding: "52px 32px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <button style={{ padding: "9px 20px", borderRadius: 8, background: "#1E40AF", color: "#fff", fontSize: 13.5, fontWeight: 600, border: "none", cursor: "pointer" }}>Request Verification</button>
      ...
      {/* Bottom CTA */}
      <section style={{ maxWidth: 1280, margin: "0 auto", padding: "64px 32px", textAlign: "center" }}>
...
function PricingPage({ onSearch, onIndustries, onNav }: { onSearch: (q: string) => void; onIndustries: () => void; onNav?: (k: string) => void }) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#F7F8FA" }}>
      ...
      {/* Contact Credits */}
      <section id="credits" style={{ maxWidth: 1280, margin: "0 auto", padding: "56px 32px 48px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 14, marginBottom: 16 }}>
          {plans.map((plan) => (
            <div key={plan.name} style={{ background: "#fff", border: plan.popular ? "2px solid #1E40AF" : "1px solid #E9ECF1", borderRadius: 12, padding: "28px 26px", position: "relative" as const, display: "flex", flexDirection: "column" }}>
              ...
              <div>
                <button style={{ width: "100%", padding: "9px 0", borderRadius: 8, background: plan.popular ? "#1E40AF" : "#fff", color: plan.popular ? "#fff" : "#1E40AF", fontSize: 13.5, fontWeight: 600, border: plan.popular ? "none" : "1.5px solid #BFCDEE", cursor: "pointer", marginBottom: plan.note ? 8 : 0 }}>
                  Buy {plan.name}
                </button>
      ...
      <section style={{ maxWidth: 1280, margin: "0 auto", padding: "52px 32px" }}>
        ...
        <div style={{ background: "#fff", border: "1px solid #E9ECF1", borderRadius: 12, padding: "28px 32px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 32, flexWrap: "wrap" as const }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "7px 32px", flex: 2, minWidth: 280 }}>
          ...
          <div style={{ flexShrink: 0 }}>
            <button style={{ padding: "10px 22px", borderRadius: 8, background: "#1E40AF", color: "#fff", fontSize: 13.5, fontWeight: 600, border: "none", cursor: "pointer", display: "block", marginBottom: 8 }}>Start Membership</button>
      ...
      {/* Comparison table */}
      <section id="compare" style={{ maxWidth: 1280, margin: "0 auto", padding: "52px 32px" }}>
        <h2 style={{ fontSize: 20, fontWeight: 700, letterSpacing: "-0.4px", color: "#0D1117", marginBottom: 24 }}>Choose the Right Option</h2>
        <div style={{ border: "1px solid #E9ECF1", borderRadius: 12, overflow: "hidden" }}>
          {/* Header */}
          <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr 1fr", background: "#F7F8FA", borderBottom: "1px solid #E9ECF1", padding: "12px 20px", gap: 8 }}>
            <span />
          ...
          {COMPARISON_ROWS.map((row, i) => (
            <div key={row.label} style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr 1fr", padding: "13px 20px", gap: 8, borderBottom: i < COMPARISON_ROWS.length - 1 ? "1px solid #F5F6F8" : undefined, alignItems: "center" }}>
      ...
      <section style={{ background: "#fff", borderTop: "1px solid #E9ECF1", borderBottom: "1px solid #E9ECF1" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "44px 32px" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1.6fr", gap: 32, alignItems: "flex-start" }}>
            <div>
            ...
            <div style={{ background: "#F7F8FA", border: "1px solid #E9ECF1", borderRadius: 10, padding: "20px 24px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "6px 16px" }}>
...
function GuidesPage({ onSearch, onVerification, onIndustries, onNav }: { onSearch: (q: string) => void; onVerification: () => void; onIndustries: () => void; onNav?: (k: string) => void }) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#F7F8FA" }}>
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "40px 32px", display: "grid", gridTemplateColumns: "192px 1fr", gap: 40, alignItems: "flex-start" }}>
      ...
      <section style={{ maxWidth: 1280, margin: "0 auto", padding: "44px 32px" }}>
      ...
      <section style={{ background: "#fff", borderTop: "1px solid #E9ECF1", borderBottom: "1px solid #E9ECF1" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "28px 32px", display: "flex", alignItems: "flex-start", gap: 14 }}>
      ...
      {/* Bottom CTA */}
      <section style={{ maxWidth: 1280, margin: "0 auto", padding: "52px 32px", textAlign: "center" }}>
        ...
        <div style={{ background: "#fff", border: "1px solid #E9ECF1", borderRadius: 14, padding: "36px 36px 28px", boxShadow: "0 1px 3px rgba(0,0,0,0.04),0 8px 24px rgba(0,0,0,0.04)" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8, marginBottom: 20 }}>
            {["Continue with Google", "Continue with LinkedIn"].map((label) => (
              <button key={label} style={{ width: "100%", padding: "10px 0", borderRadius: 8, background: "#F7F8FA", border: "1px solid #E9ECF1", fontSize: 13.5, fontWeight: 500, color: "#374151", cursor: "pointer" }}>{label}</button>
            ))}
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12, marginBottom: 20 }}>
            ...
            <div>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
                ...
                <a href="#" style={{ fontSize: 12, color: "#1E40AF", textDecoration: "none" }}>Forgot password?</a>
              </div>
          ...
          <button style={{ width: "100%", padding: "10px 0", borderRadius: 8, background: "#1E40AF", color: "#fff", fontSize: 14, fontWeight: 600, border: "none", cursor: "pointer", marginBottom: 18 }}>Sign In</button>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "40px 24px" }}>
        <div style={{ width: "100%", maxWidth: 440 }}>
          ...
          <div style={{ background: "#fff", border: "1px solid #E9ECF1", borderRadius: 14, padding: "32px 32px 24px", boxShadow: "0 1px 3px rgba(0,0,0,0.04),0 8px 24px rgba(0,0,0,0.04)" }}>
            ...
            <button style={{ width: "100%", padding: "9px 0", borderRadius: 8, background: "#F7F8FA", border: "1px solid #E9ECF1", fontSize: 13.5, fontWeight: 500, color: "#374151", cursor: "pointer", marginBottom: 16 }}>Continue with Google</button>
            ...
            <button style={{ width: "100%", padding: "10px 0", borderRadius: 8, background: "#1E40AF", color: "#fff", fontSize: 14, fontWeight: 600, border: "none", cursor: "pointer", marginBottom: 16 }}>Create Account</button>
...
function ContactPage({ onNav }: { onNav: (k: string) => void }) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#F7F8FA" }}>
      {/* Hero */}
      <section style={{ background: "#fff", borderBottom: "1px solid #E9ECF1" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "48px 32px 40px" }}>
      ...
      {/* Option cards */}
      <section style={{ maxWidth: 1280, margin: "0 auto", padding: "40px 32px 32px" }}>
          ...
          {sent ? (
            ...
            <div style={{ background: "#fff", border: "1px solid #E9ECF1", borderRadius: 12, padding: "28px 32px" }}>
              ...
              <button onClick={() => setSent(true)}
                style={{ padding: "10px 24px", borderRadius: 8, background: "#1E40AF", color: "#fff", fontSize: 13.5, fontWeight: 600, border: "none", cursor: "pointer" }}>Send Message</button>
            </div>
          )}
...
function RequestVerificationPage({ onPricing, onNav }: { onPricing: () => void; onNav: (k: string) => void }) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#F7F8FA" }}>
      ...
      {/* Options */}
      <section style={{ maxWidth: 1280, margin: "0 auto", padding: "44px 32px 36px" }}>
      ...
      {/* Form + sidebar */}
      <section id="request-form" style={{ maxWidth: 1280, margin: "0 auto", padding: "0 32px 60px" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 280px", gap: 32, alignItems: "flex-start" }}>
          {sent ? (
            ...
            <div style={{ background: "#fff", border: "1px solid #E9ECF1", borderRadius: 12, padding: "28px 32px" }}>
              ...
              <div style={{ marginTop: 22 }}>
                <button onClick={() => setSent(true)}
                  style={{ padding: "10px 24px", borderRadius: 8, background: "#1E40AF", color: "#fff", fontSize: 13.5, fontWeight: 600, border: "none", cursor: "pointer" }}>Submit Request</button>
              </div>
            </div>
          )}
      ...
      <section style={{ background: "#fff", borderTop: "1px solid #E9ECF1", borderBottom: "1px solid #E9ECF1" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "52px 32px" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1.6fr", gap: 40, alignItems: "flex-start" }}>
            ...
            <div style={{ background: "#F7F8FA", border: "1px solid #E9ECF1", borderRadius: 10, padding: "22px 26px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "8px 24px" }}>
...
export default function App() {
  ...
  const goHome         = () => { setPage({ kind: "home" }); window.scrollTo(0, 0); };
  const goResults      = (q: string) => { setPage({ kind: "results", query: q }); window.scrollTo(0, 0); };
  const goDetail       = (f: SearchResult, fromQuery = "") => { setPage({ kind: "detail", factory: f, fromQuery }); window.scrollTo(0, 0); };
  const goIndustries   = () => { setPage({ kind: "industries" }); window.scrollTo(0, 0); };
  const goVerification = () => { setPage({ kind: "verification" }); window.scrollTo(0, 0); };
  const goPricing      = () => { setPage({ kind: "pricing" }); window.scrollTo(0, 0); };
  const goGuides       = () => { setPage({ kind: "guides" }); window.scrollTo(0, 0); };
  const goSignIn       = () => { setPage({ kind: "signin" }); window.scrollTo(0, 0); };
  const goSignUp       = () => { setPage({ kind: "signup" }); window.scrollTo(0, 0); };
  const goContact      = () => { setPage({ kind: "contact" }); window.scrollTo(0, 0); };
  const goRequestVerification = () => { setPage({ kind: "request-verification" }); window.scrollTo(0, 0); };
  const goAbout        = () => { setPage({ kind: "about" }); window.scrollTo(0, 0); };
  const goPrivacy      = () => { setPage({ kind: "privacy" }); window.scrollTo(0, 0); };
  const goTerms        = () => { setPage({ kind: "terms" }); window.scrollTo(0, 0); };
  const goNotFound     = () => { setPage({ kind: "not-found" }); window.scrollTo(0, 0); };
